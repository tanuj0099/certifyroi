...
// ─────────────────────────────────────────────────────────
// ABOUT PAGE — real founder story, personal voice
// ─────────────────────────────────────────────────────────
    ...
    <PageWrapper maxWidth="820px">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={T}>
        ...
        <div className="glass" style={{ padding: 'clamp(20px,4vw,36px)', marginBottom: '20px', borderLeft: '3px solid #6366F1' }}>
          <div style={{ fontSize: '11px', color: '#818CF8', fontFamily: FM, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '16px' }}>The honest version of how this started</div>
          ...
          <p style={{ fontSize: 'clamp(13px,1.8vw,15px)', color: 'var(--text-2)', lineHeight: '1.85', fontFamily: FB }}>
            I made a spreadsheet. Pulled salary data from Naukri, AmbitionBox, LinkedIn India. Mapped break-even timelines. Ran the numbers for 8 different certifications. Two months later I had my answer — and I'd spent more time building the spreadsheet than studying for the cert itself. That spreadsheet became CertifyROI. I just didn't want anyone else to waste those two months.
          </p>
        </div>

        <div className="glass" style={{ padding: 'clamp(18px,3.5vw,28px)', marginBottom: '20px' }}>
          <div style={{ fontSize: '11px', color: '#10B981', fontFamily: FM, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '16px' }}>What actually bothered me</div>
          <p style={{ fontSize: 'clamp(13px,1.8vw,15px)', color: 'var(--text-2)', lineHeight: '1.85', marginBottom: '16px', fontFamily: FB }}>
            It wasn't just that the information was vague. It was that every "career advice" site had affiliate links to the certification. They were being paid to recommend it. There was no honest, disinterested source that would tell an Indian professional in Pune earning ₹8L/year whether CFA Level 1 was a better use of ₹1.2L than three short Google certifications.
          </p>
          <p style={{ fontSize: 'clamp(13px,1.8vw,15px)', color: 'var(--text-2)', lineHeight: '1.85', fontFamily: FB }}>
            We don't have affiliate deals. We don't get paid by certification bodies. If the numbers say a cert is not worth it for your profile, we'll say that. The only metric we optimise for is whether the tool is actually useful to you.
          </p>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: '14px', marginBottom: '20px' }}>
          {[
            { emoji: '😰', title: 'The anxious one at 11pm', desc: 'Watching peers get promoted. Feeling left behind. Scrolling LinkedIn and feeling sick about it. We built this for that person first — because that was me.', color: '#818CF8' },
            { emoji: '🔄', title: 'The career switcher', desc: 'Ops manager who wants to move into data. Bank employee who wants to break into tech. The MBA-or-cert question is a real and expensive decision. We help you answer it with numbers.', color: '#51B1E7' },
            { emoji: '🎓', title: 'The fresh graduate', desc: 'No salary history, no benchmark, just a window to get a strong first offer. Student Mode exists because the ROI math is completely different when you\'re starting from zero.', color: '#10B981' },
            { emoji: '📊', title: 'The person pitching their boss', desc: '"My manager won\'t sponsor my cert without an ROI case." Pitch Your Boss exists because this is a real Tuesday-morning conversation happening in thousands of Indian offices.', color: '#F59E0B' },
          ].map(function(c, i) {
            return (
        ...
        <div className="glass" style={{ padding: 'clamp(18px,3.5vw,28px)', marginBottom: '20px' }}>
          <div style={{ fontSize: '11px', color: '#F59E0B', fontFamily: FM, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '16px' }}>What's under the hood</div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(180px,1fr))', gap: '14px' }}>
            {[
              { label: 'AI Engine',     value: 'Groq · llama-3.3-70b',       desc: 'Under 2 seconds inference. Resume analysis and ROI verdict in real time.' },
              { label: 'Salary Data',  value: 'NASSCOM + LinkedIn + Naukri', desc: 'India-specific 2026 benchmarks. City-level. Updated quarterly.' },
              { label: 'Cert Database', value: '103 certifications',          desc: '17 domains — tech, finance, medical, law, government, architecture, and more.' },
              { label: 'City Coverage', value: '8 major metros',              desc: 'Bangalore, Hyderabad, Pune, Mumbai, Delhi, Chennai, Kolkata, Ahmedabad. Haversine nearest-match for other cities.' },
            ].map(function(item, i) {
              return (
        ...
        <div className="glass" style={{ padding: 'clamp(18px,3.5vw,24px)', marginBottom: '20px', background: 'rgba(239,68,68,0.04)', borderColor: 'rgba(239,68,68,0.15)' }}>
          ...
          <p style={{ fontSize: 'clamp(13px,1.8vw,14px)', color: 'var(--text-2)', lineHeight: '1.75', fontFamily: FB }}>
            CertifyROI is not a certification prep platform. We don't sell courses. We don't have affiliate deals with Coursera, Udemy, or any certification body. We get nothing if you buy a cert. Our only incentive is to give you honest numbers — including the number that says a particular cert is not worth it for your specific profile. That independence is the only thing that makes this tool actually useful.
          </p>
        </div>
...
// ─────────────────────────────────────────────────────────
// BLOG — 30 posts across all domains
// ─────────────────────────────────────────────────────────
const BLOG_POSTS = [
  ...
  { id: 29, tag: 'Marketing',       tagColor: '#EC4899', domain: 'marketing',     title: 'HubSpot vs Meta vs Google: Which Digital Marketing Stack to Certify In?', date: 'Jan 2026', readTime: '5 min', forWho: 'Student',  excerpt: 'Three platform ecosystems. Three certification stacks. Each one opens a different slice of India\'s digital marketing job market.\n\nGoogle (Search Ads + Analytics 4): essential for performance marketing roles at agencies and D2C brands. Free certifications, high recognition. If you\'re targeting entry roles, Google is your baseline.\n\nMeta Blueprint: performance marketers at FMCG, fashion, and consumer brands in India prioritise Meta skills. Blueprint certifications signal you can actually spend media budgets profitably.\n\nHubSpot: best for B2B marketing, SaaS, and inbound roles. HubSpot certification is free, widely respected, and the CRM knowledge transfers across jobs.\n\nOur stack recommendation for a fresher: Google Analytics + HubSpot Content + Meta Blueprint. Three certs, under ₹5,000, all free or near-free. This combination covers 80% of entry digital marketing job requirements in India.' },
  { id: 30, tag: 'HR & People',     tagColor: '#A855F7', domain: 'hr',            title: 'People Analytics Certification: Is It Worth It for HR Professionals in 2026?', date: 'Mar 2026', readTime: '5 min', forWho: 'Professional', excerpt: 'People Analytics is the fastest-growing sub-discipline in HR. Indian companies — especially in tech, BFSI, and large manufacturing — are building people analytics teams from scratch.\n\nThe University of Pennsylvania People Analytics Certificate (Coursera, ₹15,000, 3 months) is the most respected short-form credential in this space. It covers workforce planning, HR metrics, regression analysis for people data, and dashboard design.\n\nSalary premium in India: HR professionals with demonstrated people analytics skills command ₹4–8L more than peers at the same experience level at MNCs and product companies.\n\nThe catch: the cert alone isn\'t enough. You need a portfolio project — ideally a real workforce analysis you ran at your current company using Excel or Python. That\'s what turns the cert into a promotion.' },
]
    ...
    <PageWrapper maxWidth="1060px">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={T}>
        ...
        <p style={{ fontSize: '15px', color: 'var(--text-3)', marginBottom: '12px', fontFamily: FB }}>
          {BLOG_POSTS.length} data-driven career guides. No fluff. No affiliate links. Just numbers and honest takes.
        </p>
...
// ─────────────────────────────────────────────────────────
// FAQ — 20 questions across 4 categories
// ─────────────────────────────────────────────────────────
const FAQPage = function() {
  ...
  var faqs = [
    ...
    { category: 'Product', q: 'What is the difference between Resume AI and the ROI Calculator?', a: 'Resume AI (Step 1) is for discovery — you don\'t know which cert to pursue yet. You upload your resume and the AI reads your background and recommends the top 3 certifications based on your domain and location. ROI Calculator (Step 2) is for validation — you already know which cert and want to see the exact financial numbers: break-even to the month, 5-year net gain, monthly salary change, and an AI verdict on whether it\'s worth it for your profile.' },
    { category: 'Product', q: 'Why does Student Mode exist?', a: 'Standard ROI calculators assume you have a salary to compare against. Students don\'t. Student Mode removes salary sliders entirely and reframes the calculation around time-to-first-offer, fresher salary benchmarks in your city, and career investment ROI. The cert recommendations also shift — Student Mode prioritises certs with strong fresher hiring signals over certs that maximise salary hikes for experienced professionals.' },
    { category: 'Product', q: 'What is Pitch Your Boss?', a: 'Pitch Your Boss is an AI email generator for professionals who need to justify a certification to their manager for company sponsorship. You enter the cert name, your current role, and the expected ROI, and it generates a professional, data-backed email you can send or adapt. It\'s only available in Professional mode because that\'s the context where this conversation actually happens.' },
    { category: 'Product', q: 'What is the Cert to Job Map?', a: 'The Job-Cert Map shows exactly which certifications are required or preferred for specific roles across government positions (UPSC, SSC, PSU exams) and private sector roles at major Indian employers (TCS, Infosys, Deloitte, HDFC Bank, etc.). Government data is from official recruitment notifications. Private sector data is employee-reported via LinkedIn and AmbitionBox.' },
    { category: 'Product', q: 'How is Career Simulator different from the ROI Calculator?', a: 'The ROI Calculator analyses one certification in isolation — what does THIS cert do to your salary over 5 years. The Career Simulator models a multi-cert trajectory — if you do AWS SAA now, then CKA in 18 months, then AWS DevOps Pro after that, what does your salary curve look like at each milestone. It\'s for planning a 3–5 year career path, not evaluating a single decision.' },
    // Data & Accuracy
    { category: 'Data & Accuracy', q: 'How accurate are the salary figures?', a: 'Salary data is sourced from LinkedIn Economic Graph India, NASSCOM 2026 talent survey, Naukri salary insights, AmbitionBox self-reported data, and WEF India Future of Jobs 2025. All figures are medians — half of earners are above, half below. Individual results vary significantly based on company tier, negotiation skill, prior experience, and economic conditions. We update data quarterly.' },
    { category: 'Data & Accuracy', q: 'Is my resume stored anywhere?', a: 'No. Resume text is processed in real-time using the Groq inference API and is not stored, logged, or retained in any database. The text goes in, the analysis comes out, and the data is gone. We do not have access to your resume after the analysis completes. This is by design, not just policy.' },
    { category: 'Data & Accuracy', q: 'My city isn\'t one of the 8. What happens?', a: 'We have salary and demand data for 8 cities: Bangalore, Hyderabad, Pune, Mumbai, Delhi NCR, Chennai, Kolkata, and Ahmedabad. If your city isn\'t in our database, we use the Haversine formula — a geographic distance calculation using latitude and longitude — to identify the nearest city from our list and show that data with a clear disclosure. India national median salary is also shown below for comparison, so you have two reference points.' },
    { category: 'Data & Accuracy', q: 'How often is the cert database updated?', a: 'The certification list (103 certs across 17 domains) is reviewed quarterly. New certs are added when they appear in 50+ job postings on Naukri in a 30-day period. Certs are removed when demand drops below a threshold or the certification body discontinues them. Salary hike and demand data updates quarterly using the sources listed above.' },
    // Career Questions
    { category: 'Career Questions', q: 'I have no tech background. Can I still use CertifyROI?', a: 'Yes. CertifyROI covers finance (CFA, FMVA, CMA, CA, NISM), management (PMP, CSM, Six Sigma), marketing (Google, HubSpot, Meta), HR (SHRM, People Analytics), product management, architecture (LEED, CoA), medical (DNB, USMLE, PLAB, ACRP), law (Bar, CS), civil and mechanical engineering certifications, and government exam prep (GATE, UPSC, SSC, IBPS). The database spans 17 domains — tech is just one of them.' },
    { category: 'Career Questions', q: 'I want to switch careers completely. Where do I start?', a: 'Upload your resume in Step 1. The AI will identify your transferable skills and map the fastest viable certification path to your target domain. The fastest ROI switches we\'ve seen: ops/finance → data analytics (IBM Data Science, 5 months), backend dev → cloud (AWS SAA, 3 months), MBBS → clinical research (ACRP CRA, 4 months). The key insight is always the same: your old domain knowledge is an asset in your new one, not a liability.' },
    { category: 'Career Questions', q: 'Can switchers and professionals see long-term certifications like CA or CFA?', a: 'For Career Switchers and Professionals, we automatically show fast-track certifications first — certs completable in under 6 months. Long-term programs (CA, CFA, ACCA, PGDM) are hidden by default because someone looking for a career move in the next 6 months shouldn\'t start a 3-year program. You can reveal long-term certs with a "Show long-term options" toggle if your timeline allows.' },
    { category: 'Career Questions', q: 'Can CertifyROI help with government exam preparation planning?', a: 'We can tell you the ROI profile of government exams — starting salaries, allowances, career trajectories, prep costs, realistic pass rates, and break-even timelines. We can\'t help with the actual exam preparation content. CertifyROI helps you decide whether a government exam path makes sense for your profile and financial situation — not how to crack it. Use us for the decision; use a specialised coaching platform for the preparation.' },
    // Technical
    { category: 'Technical', q: 'The AI analysis gave me a weird result. What should I do?', a: 'The AI can occasionally produce off-format or unexpected responses. If the result looks wrong, try refreshing and re-running — AI responses vary slightly each time. If you\'re getting consistently poor results, the issue is likely the resume input: very short resumes (under 150 words), PDF extraction errors, or highly formatted PDFs with tables and columns can produce poor analysis. Try pasting your resume text directly into the text area instead of uploading the PDF.' },
    { category: 'Technical', q: 'My PDF isn\'t being read correctly. What\'s happening?', a: 'PDF text extraction works best on standard, text-based PDFs created directly in Word or similar tools. Issues occur with: scanned PDFs (image-based with no actual text layer), highly formatted PDFs with complex tables and columns, PDFs with custom or embedded fonts, and password-protected files. If extraction fails or produces garbled text, paste your resume text directly — same results, fewer headaches.' },
    { category: 'Technical', q: 'Why does the app ask me to choose Student, Switcher, or Professional?', a: 'Your career mode fundamentally changes how the tool works — not just cosmetically. Student Mode removes salary assumptions and focuses on first-offer benchmarks. Switcher Mode surfaces fast-track certs and filters out long programs that wouldn\'t fit your timeline. Professional Mode enables Pitch Your Boss and shows full salary hike data. Choosing the wrong mode will give you inaccurate recommendations. Pick the one that honestly describes where you are right now.' },
    { category: 'Technical', q: 'Is there a mobile app?', a: 'CertifyROI is a mobile-optimised web app. There\'s no separate app to install — open certifyroi.vercel.app in your mobile browser and it works fully. The interface is built specifically for mobile — all tools, the resume analyser, the heatmap, and the ROI calculator are fully functional on any screen size. You can add it to your home screen from Safari or Chrome for an app-like experience.' },
    { category: 'Technical', q: 'Why does my session reset when I close the tab?', a: 'If you\'re using CertifyROI as a guest (without signing in), your preferences and analysis history are stored in localStorage, which persists across sessions on the same device. However, guest AI analysis count resets if you clear your browser data. Sign in with Google to permanently save your analysis history, cert preferences, and profile across all devices.' },
    { category: 'Technical', q: 'I found incorrect salary data for my city and cert. How do I report it?', a: 'We genuinely want to know. Use the Contact page to send us: the cert name, your city, the salary figure you saw on CertifyROI, and a link to the data source you believe is more accurate (LinkedIn salary insights, a recent job posting, your own offer letter range). We review all reported corrections and update the database quarterly. Your correction might help thousands of other professionals make a better decision.' },
  ]
    ...
    <PageWrapper maxWidth="760px">
      <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }} transition={T}>
        ...
        <p style={{ fontSize:'15px', color:'var(--text-3)', marginBottom:'36px', fontFamily:FB }}>
          {faqs.length} questions answered honestly. No corporate speak.
        </p>
...
// Study Tracker (BurnRate) removed — not in TOOL_TABS
const STEP_TABS = [
  ...
  return (
    <>
      ...
      >
        ...
        {currentPage === 'app' ? (
          <div>
            {/* ── Row 1: Core Flow steps — CENTERED ── */}
            <div style={{ borderTop:'1px solid var(--border)', background:'var(--bg)' }}>
              <div style={{
                maxWidth:'1240px', margin:'0 auto', padding:'0 12px',
                  ...
                  <div>
                    ...
                    >
                      <motion.button
                        ...
                        whileHover={{ x: 4, boxShadow: '0 8px 32px rgba(99,102,241,0.35)' }}
                        whileTap={{ scale: 0.97 }}
                        style={{
                          ...
                          fontSize: '14px', fontFamily: FH, fontWeight: '700',
                    ...
                    >
                      <motion.button
                        ...
                        style={{
                          ...
                          color: 'var(--text-4)', fontSize: '13px',
                          fontFamily: FH, fontWeight: '600', cursor: 'pointer',
                        }}
                      >
      ...
      <div style={{ maxWidth:'1240px', margin:'0 auto' }}>
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(160px,1fr))', gap:'28px', marginBottom:'32px' }}>
          <div>
            ...
            <p style={{ fontSize:'11px', color:'var(--text-4)', fontFamily:FM, opacity:0.6 }}>Data: LinkedIn · NASSCOM · Naukri · WEF 2026</p>
          </div>
          <div>
            ...
            {['Resume AI','ROI Calculator','City Demand','Compare Certs','Career Simulator','Cert to Job Map'].map(function(l) {
              return (

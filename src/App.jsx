...
function AppRoot() {
  ...
  var handleModeSelect = function (id) {
    setMode(id);
    setModeLocked(true);
  };
  var handleModeReset = function () {
    setModeLocked(false);
  };
